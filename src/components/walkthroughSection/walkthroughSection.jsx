...
const TEXT1=['1—browse','Browse our tech catalog with more than 20 top tech products']
const TEXT2=['2—choose','Exchange your hard earned AeroPoints for the item you want']
const TEXT3=['3—enjoy!','All done, you can relax! We’ll take care of delivery of your tech item!']
